  ...
  <dl id="grpInfoWrap">
    ...
    <table id="grpInfo">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row">상세 코드 <span class="font_red">*</span></th>
          <td>
            <input
              type="text"
              class="form-control"
    ...
    <div class="btn_areaC mt30">
      ...
      <a @click="deletedtlcd()" class="btn btn-danger mx-2" v-show="delshow">
        <span>삭제</span>
      </a>
...
export default {
  ...
  props: { title: String, grpcd: String, grpcdnm: String, dtlcod: String, action: String },
  data: function () {
    return {
      pgrpcd: this.grpcd,
      grp_cod: this.grpcd,
      grp_cod_nm: this.grpcdnm,
      dtl_cod: "",
      dtl_cod_nm: "",
      dtl_cod_eplti: "",
      dtl_use_poa: "Y",
  ...
  mounted: function () {
    let vm = this;
    // 신규 등록 시
    if (this.dtlcod == null || this.dtlcod == "") {
      vm.grp_cod = this.grpcd;
      vm.grp_cod_nm = this.grpcdnm;
      vm.dtl_cod = "";
      vm.dtl_cod_nm = "";
      vm.dtl_cod_eplti = "";
      vm.dtl_use_poa = "Y";
      ...
      params.append("dtl_cod", this.dtlcod);
      ...
      this.axios
        ...
        .then(function (response) {
          ...
          vm.grp_cod = response.data.comnDtlCodModel.grp_cod;
          vm.grp_cod_nm = response.data.comnDtlCodModel.grp_cod_nm;
          ...
          if (response.data.comnDtlCodModel != undefined && response.data.comnDtlCodModel!="" && response.data.comnDtlCodModel != null) {
            vm.delshow = true;
          } else {
            vm.delshow = false;
          }
  ...
  methods: {
    save: function () {
      if (confirm("저장하시겠습니까?")) {
        ...
        params.append("dtl_grp_cod", this.grp_cod);
        params.append("dtl_grp_cod_nm", this.grp_cod_nm);
